...
/**
 * 后台-商品管理
 * Created by 刘千山 on 2023/7/3/003-15:52
 */
@RestController
...
public class PmsProductController {
    ...
    public CommonResult<Object> create(@RequestBody PmsProductParam productParam) {
    ...
    public CommonResult<Object> update(@PathVariable Long id, @RequestBody PmsProductParam productParam) {
