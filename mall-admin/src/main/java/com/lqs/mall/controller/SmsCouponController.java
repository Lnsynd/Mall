...
/**
 * 优惠券管理Controller
 * Created by 刘千山 on 2023/7/5/005-08:34
 */
@RestController
...
public class SmsCouponController {
    ...
    public CommonResult<Object> add(@RequestBody SmsCouponParam couponParam) {
    ...
    public CommonResult<Object> update(@PathVariable Long id,@RequestBody SmsCouponParam couponParam) {
    ...
    @ApiOperation("获取单个优惠券的详细信息(包含绑定关系)")
