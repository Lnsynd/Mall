...
import com.lqs.mall.service.UmsMemberReceiveAddressService;
...
/**
 * 会员收货地址管理Controller
 * Created by 刘千山 on 2023/7/5/005-10:39
 */
@RestController
...
public class UmsMemberReceiveAddressController {
    ...
    public CommonResult<Object> add(@RequestBody UmsMemberReceiveAddress address) {
    ...
    public CommonResult<Object> update(@PathVariable Long id, @RequestBody UmsMemberReceiveAddress address) {
