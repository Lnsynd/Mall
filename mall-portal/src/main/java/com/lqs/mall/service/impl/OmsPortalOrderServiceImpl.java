...
import com.lqs.mall.dao.PortalOrderDao;
import com.lqs.mall.dao.PortalOrderItemDao;
import com.lqs.mall.domain.*;
import com.lqs.mall.mapper.*;
import com.lqs.mall.model.*;
import com.lqs.mall.service.*;
...
public class OmsPortalOrderServiceImpl implements OmsPortalOrderService {
     ...
     * 获取该用户可以使用的优惠券
     *
     * @param cartPromotionItemList 含有优惠信息的 购物车信息
     * @param couponId              可使用的优惠券id
     */
    private SmsCouponHistoryDetail getUseCoupon(List<CartPromotionItem> cartPromotionItemList, Long couponId) {
        // 已领取的全部的优惠券列表
        List<SmsCouponHistoryDetail> couponHistoryDetails = memberCouponService.listCart(cartPromotionItemList, 1);
